    ...
    switch (name) {
      ...
      case "password2":
        formErrors.password2 =
          value != value.password ? "Passwörter sind unterschiedlich" : "";
        break;
      default:
          console.log("Break");
        break;
                    ...
                    <span className="input-container">
                      ...
                      <div className="btn-group roleBtn">
                        <div
                          ...
                          className={
                            this.state.isStudent ? 'btn-specialButton btn active' : 'btn-specialButton btn'
                          }
                        ...
                        <div
                          ...
                          className={
                            this.state.isStudent ? 'btn-specialButton btn' : 'btn-specialButton btn active'
                          }
