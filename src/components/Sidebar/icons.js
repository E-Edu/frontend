...
export default ({
    ...
    "check-active.svg": checkactive,
    "check.svg": check,
    "edit-active.svg": editactive,
    "edit.svg": edit,
    "home-active.svg": homeactive,
    "home.svg": home,
    "list-active.svg": listactive,
    "list.svg": list,
    "plus-circle-active.svg": pluscircleactive,
    "plus-circle.svg": pluscircle,
    "settings-active.svg": settingsactive,
