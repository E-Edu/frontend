        ...
        return this.state.tasks.map((task, index) => {
            return (
                <Link key={task.id} to="/task/subject" style={{ textDecoration: 'none', color: 'inherit' }}>
                    <Task
                        name={`${i18n.t('taskList.task')} ${index + 1}`}
                        questions="12"
                        rightQuestions="10"
                ...
                <div className="task-list main">
                    <div className="result-content-header">
                        <div className="result-left">
                            <span className="result-subject">{i18n.t('taskList.task')}</span>
                        </div>

                        <div className="middle">
                            <div className="result-center">
                                <IconText
                                    text={`213 ${i18n.t('taskList.points')}`}
                                    position="left"
                            ...
                            <div className="result-center second">
                                <IconText
                                    text={`21.323 ${i18n.t('taskList.points')}`}
                                    position="left"
                                    class="result-subject"
                                    fontColor="#3A506B">
                            ...
                            <span className="result-subject">
                                <div id="input-search">
                                    ...
                                    <input
                                        ...
                                        name="search"
                                        aria-label="Search"
                                        placeholder={i18n.t('taskList.search')}
                                    />
                                </div>
                            </span>
                        </div>
