        ...
        return (
            <div className='privacy'>
                ...
                <div className='fontBox'>
                    ...
                    <p>At E-Edu Lernplatform, accessible from https://e-edu.the-morpheus.de/, one of our main priorities
                        is the privacy of our visitors. This Privacy Policy document contains types of information that
                        is collected and recorded by E-Edu Lernplatform and how we use it.</p>
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in E-Edu Lernplatform.
                    ...
                    <p>E-Edu Lernplatform follows a standard procedure of using log files. These files log visitors when
                        ...
                        with the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy
                            Generator</a> and the <a href="https://www.privacypolicytemplate.net/">Privacy Policy
                            Template</a>.</p>

                    <h2>Cookies and Web Beacons</h2>

                    <p>Like any other website, E-Edu Lernplatform uses 'cookies'. These cookies are used to store
                    ...
                    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
                        E-Edu Lernplatform.</p>

                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                        that are used in their respective advertisements and links that appear on E-Edu Lernplatform,
                    ...
                    <p>Note that E-Edu Lernplatform has no access to or control over these cookies that are used by
                        third-party advertisers.</p>

                    <h2>Third Party Privacy Policies</h2>

                    <p>E-Edu Lernplatform's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                    ...
                    <p>E-Edu Lernplatform does not knowingly collect any Personal Identifiable Information from children
