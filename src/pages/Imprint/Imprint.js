            ...
            <div className='imprint'>
                ...
                <div className='fontBox'>
                    <p class="3DMsoNoSpacing">
                        <span class="font0.8rem">Sind Sie Betreiber einer kommerziellen Seite, so unterliegen Sie der Impressumspflicht. Da dies sehr viel Mühe und viel Fachwissen erfordert, haben wir hier für Sie eine kostenlose Vorlage erstellt. </span>
                    </p>
                    <p class="3DMsoNoSpacing">
                    ...
                    <p class="3DMsoNoSpacing">
                        <span class="font0.8rem">Wenn Sie diese Vorlage verwenden, so verwenden Sie dies bitte vollständig. </span>Der
                        Haftungsausschluss ist auf deutsch und kann nur für Webseiten benutzt werden, die Ihren Sitz in
                        Deutschland haben und somit das deutsche Recht gilt.</p>
                    <p class="3DMsoNoSpacing">&nbsp;</p>
                    <p><strong>Impressum</strong></p>
                    <p>&nbsp;</p><p><span class="underline">Angaben gem. § 5 TMG:</span></p>
                    <p>&nbsp;</p><p>Vorname, Name</p><p>Adresse</p><p>PLZ</p><p>&nbsp;</p>
                    <p><span class="underline">Kontaktaufnahme:</span></p>
                    <p>&nbsp;</p><p>Telefon:</p><p>Fax:</p><p>E-Mail:</p><p>&nbsp;</p>
                    <p><strong>Umsatzsteuer-ID</strong></p><p><span class="underline">&nbsp;</span></p>
                    <p><span class="underline">Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:</span>
                    </p>
                    <p>&nbsp;</p><p>DE XXX XXX XXX</p><p><strong><span class="underline">&nbsp;</span></strong></p>
                    <p><strong>Haftungsausschluss - Disclaimer:</strong></p><p>&nbsp;</p><p><span class="underline">Haftung für Inhalte</span>
                </p>
                    <p><strong>&nbsp;</strong></p>
                    <p>Alle Inhalte unseres Internetauftritts wurden mit größter Sorgfalt und nach bestem Gewissen
                    ...
                    <p>Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der Kenntniserlangung einer
                        konkreten Rechtsverletzung möglich. Bei Bekanntwerden von den o.g. Rechtsverletzungen werden wir
                        diese Inhalte unverzüglich entfernen.</p>
                    <p>&nbsp;</p>
                    <p><span class="underline">Haftungsbeschränkung für externe Links</span></p>
                    <p><strong>&nbsp;</strong></p>
                    <p>Unsere Webseite enthält Links auf externe Webseiten Dritter. Auf die Inhalte dieser direkt oder
                        ...
                        Links sind die jeweilige Anbieter oder Betreiber (Urheber) der Seiten verantwortlich.</p>
                    <p>Die externen Links wurden zum Zeitpunkt der Linksetzung auf eventuelle Rechtsverstöße überprüft
                        und waren im Zeitpunkt der Linksetzung frei von rechtswidrigen Inhalten. Eine ständige
                        inhaltliche Überprüfung der externen Links ist ohne konkrete Anhaltspunkte einer
                        ...
                        ausschließlich in dem Fall nur bestehen, wenn wir von den Inhalten Kenntnis erlangen und es uns
                        technisch möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu
                        verhindern.</p>
                    <p>Diese Haftungsausschlusserklärung gilt auch innerhalb des eigenen Internetauftrittes „<em>Name
                        Ihrer Domain</em>“ gesetzten Links und Verweise von Fragestellern, Blogeinträgern, Gästen des
                        Diskussionsforums. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für
                        Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargestellten Informationen entstehen,
                        haftet allein der Diensteanbieter der Seite, auf welche verwiesen wurde, nicht derjenige, der
                        über Links auf die jeweilige Veröffentlichung lediglich verweist.</p>
                    <p>Werden uns Rechtsverletzungen bekannt, werden die externen Links durch uns unverzüglich
                        entfernt.</p><p>&nbsp;</p><p><span class="underline">Urheberrecht</span></p>
                    <p><strong>&nbsp;</strong></p>
                    <p>Die auf unserer Webseite veröffentlichen Inhalte und Werke unterliegen dem deutschen Urheberrecht
